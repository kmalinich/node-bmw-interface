...
async function pusher(data = null) {
	if (data !== null) await proto[module_name].queue_input.push(data);
...
async function parser() {
	...
	proto[module_name].queue_input = await proto[module_name].queue_input.slice(process_return.slice);
