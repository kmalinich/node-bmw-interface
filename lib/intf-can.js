...
function change_handler(topic, msg) {
	...
	socket.send('bus-rx', { bus : app_intf, msg, topic, type : 'parsed-canbus' });
...
async function init() {
	...
	// Add listeners for DSC ARBID 0x1F8 events
	intf.intf.db.ptcan.messages.ASC4.signals.vehicle_dsc_brake_pressure_pedal.onChange(message => change_handler('vehicle.dsc.brake_pressure.pedal', message.value));

	// Add listeners for DME ARBID 0x316 events
	intf.intf.db.ptcan.messages.DME_316.signals.engine_ignition_0.onChange(message => change_handler('engine.ignition_0', message.value));
	intf.intf.db.ptcan.messages.DME_316.signals.engine_ignition_1.onChange(message => change_handler('engine.ignition_1', message.value));
	...
	// Add listeners for DME ARBID 0x545 events
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_ac_switch.onChange(message                     => change_handler('dme.status.ac_switch',                     message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_battery_light.onChange(message                 => change_handler('dme.status.battery_light',                 message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_check_engine.onChange(message                  => change_handler('dme.status.check_engine',                  message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_check_fuel_cap.onChange(message                => change_handler('dme.status.check_fuel_cap',                message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_coolant_overtemperature_light.onChange(message => change_handler('dme.status.coolant_overtemperature_light', message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_cruise.onChange(message                        => change_handler('dme.status.cruise',                        message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_eml.onChange(message                           => change_handler('dme.status.eml',                           message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_oil_level_error.onChange(message               => change_handler('dme.status.oil_level_error',               message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_oil_level_error_s62.onChange(message           => change_handler('dme.status.oil_level_error_s62',           message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_oil_level_warning.onChange(message             => change_handler('dme.status.oil_level_warning',             message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_oil_pressure_light.onChange(message            => change_handler('dme.status.oil_pressure_light',            message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_tachometer_light_0.onChange(message            => change_handler('dme.status.tachometer_light_0',            message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_tachometer_light_1.onChange(message            => change_handler('dme.status.tachometer_light_1',            message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_tachometer_light_2.onChange(message            => change_handler('dme.status.tachometer_light_2',            message.value));
	intf.intf.db.ptcan.messages.DME_545.signals.dme_status_upshift_light.onChange(message                 => change_handler('dme.status.upshift_light',                 message.value));
