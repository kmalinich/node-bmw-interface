...
async function init() {
	...
	intf.intf.db.ptcan.messages.DME_316.signals['engine.ignition_0'].onChange(message => change_handler('engine.ignition_0', message.value));
	intf.intf.db.ptcan.messages.DME_316.signals['engine.ignition_1'].onChange(message => change_handler('engine.ignition_1', message.value));
