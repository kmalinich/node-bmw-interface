...
async function write() {
	...
	// Bounce if this particular queue item is already being written
	if (queueItem.writing === true) return;

	if (queueItem.attemptCount === 0 && config.options.debug[app_intf] === true) {
